...
#include "vgg_mnist_relu_off_maxpool_off.h"
#define BUNDLE_ENTRY vgg_mnist_relu_off_maxpool_off
#define BUNDLE_CONSTANT_MEM_SIZE VGG_MNIST_RELU_OFF_MAXPOOL_OFF_CONSTANT_MEM_SIZE
#define BUNDLE_MUTABLE_MEM_SIZE VGG_MNIST_RELU_OFF_MAXPOOL_OFF_MUTABLE_MEM_SIZE
#define BUNDLE_ACTIVATIONS_MEM_SIZE VGG_MNIST_RELU_OFF_MAXPOOL_OFF_ACTIVATIONS_MEM_SIZE
#define BUNDLE_MEM_ALIGN VGG_MNIST_RELU_OFF_MAXPOOL_OFF_MEM_ALIGN
#define BUNDLE_DATA_OFFSET VGG_MNIST_RELU_OFF_MAXPOOL_OFF_data
#define BUNDLE_OUTPUT_OFFSET VGG_MNIST_RELU_OFF_MAXPOOL_OFF_output
#define BUNDLE_INPUT_CHANNELS 1
#define BUNDLE_INPUT_HEIGHT 28
#define BUNDLE_INPUT_WIDTH 28
#define BUNDLE_NAME "relu_off_maxpool_off"
#elif defined(BUNDLE_CASE_RELU_ON_MAXPOOL_OFF) && defined(BUNDLE_VARIANT_MNIST)
#include "vgg_mnist_relu_on_maxpool_off.h"
#define BUNDLE_ENTRY vgg_mnist_relu_on_maxpool_off
#define BUNDLE_CONSTANT_MEM_SIZE VGG_MNIST_RELU_ON_MAXPOOL_OFF_CONSTANT_MEM_SIZE
#define BUNDLE_MUTABLE_MEM_SIZE VGG_MNIST_RELU_ON_MAXPOOL_OFF_MUTABLE_MEM_SIZE
#define BUNDLE_ACTIVATIONS_MEM_SIZE VGG_MNIST_RELU_ON_MAXPOOL_OFF_ACTIVATIONS_MEM_SIZE
#define BUNDLE_MEM_ALIGN VGG_MNIST_RELU_ON_MAXPOOL_OFF_MEM_ALIGN
#define BUNDLE_DATA_OFFSET VGG_MNIST_RELU_ON_MAXPOOL_OFF_data
#define BUNDLE_OUTPUT_OFFSET VGG_MNIST_RELU_ON_MAXPOOL_OFF_output
#define BUNDLE_INPUT_CHANNELS 1
#define BUNDLE_INPUT_HEIGHT 28
#define BUNDLE_INPUT_WIDTH 28
#define BUNDLE_NAME "relu_on_maxpool_off"
#elif defined(BUNDLE_CASE_RELU_ON_MAXPOOL_ON) && defined(BUNDLE_VARIANT_MNIST)
#include "vgg_mnist_relu_on_maxpool_on.h"
#define BUNDLE_ENTRY vgg_mnist_relu_on_maxpool_on
#define BUNDLE_CONSTANT_MEM_SIZE VGG_MNIST_RELU_ON_MAXPOOL_ON_CONSTANT_MEM_SIZE
#define BUNDLE_MUTABLE_MEM_SIZE VGG_MNIST_RELU_ON_MAXPOOL_ON_MUTABLE_MEM_SIZE
#define BUNDLE_ACTIVATIONS_MEM_SIZE VGG_MNIST_RELU_ON_MAXPOOL_ON_ACTIVATIONS_MEM_SIZE
#define BUNDLE_MEM_ALIGN VGG_MNIST_RELU_ON_MAXPOOL_ON_MEM_ALIGN
#define BUNDLE_DATA_OFFSET VGG_MNIST_RELU_ON_MAXPOOL_ON_data
#define BUNDLE_OUTPUT_OFFSET VGG_MNIST_RELU_ON_MAXPOOL_ON_output
#define BUNDLE_INPUT_CHANNELS 1
#define BUNDLE_INPUT_HEIGHT 28
#define BUNDLE_INPUT_WIDTH 28
#define BUNDLE_NAME "relu_on_maxpool_on"
#elif defined(BUNDLE_CASE_RELU_OFF_MAXPOOL_OFF) && defined(BUNDLE_VARIANT_CIFAR)
#include "vgg_cifar_relu_off_maxpool_off.h"
#define BUNDLE_ENTRY vgg_cifar_relu_off_maxpool_off
#define BUNDLE_CONSTANT_MEM_SIZE VGG_CIFAR_RELU_OFF_MAXPOOL_OFF_CONSTANT_MEM_SIZE
#define BUNDLE_MUTABLE_MEM_SIZE VGG_CIFAR_RELU_OFF_MAXPOOL_OFF_MUTABLE_MEM_SIZE
#define BUNDLE_ACTIVATIONS_MEM_SIZE VGG_CIFAR_RELU_OFF_MAXPOOL_OFF_ACTIVATIONS_MEM_SIZE
#define BUNDLE_MEM_ALIGN VGG_CIFAR_RELU_OFF_MAXPOOL_OFF_MEM_ALIGN
#define BUNDLE_DATA_OFFSET VGG_CIFAR_RELU_OFF_MAXPOOL_OFF_data
#define BUNDLE_OUTPUT_OFFSET VGG_CIFAR_RELU_OFF_MAXPOOL_OFF_output
#define BUNDLE_INPUT_CHANNELS 3
#define BUNDLE_INPUT_HEIGHT 32
#define BUNDLE_INPUT_WIDTH 32
#define BUNDLE_NAME "relu_off_maxpool_off"
#elif defined(BUNDLE_CASE_RELU_ON_MAXPOOL_OFF) && defined(BUNDLE_VARIANT_CIFAR)
#include "vgg_cifar_relu_on_maxpool_off.h"
#define BUNDLE_ENTRY vgg_cifar_relu_on_maxpool_off
#define BUNDLE_CONSTANT_MEM_SIZE VGG_CIFAR_RELU_ON_MAXPOOL_OFF_CONSTANT_MEM_SIZE
#define BUNDLE_MUTABLE_MEM_SIZE VGG_CIFAR_RELU_ON_MAXPOOL_OFF_MUTABLE_MEM_SIZE
#define BUNDLE_ACTIVATIONS_MEM_SIZE VGG_CIFAR_RELU_ON_MAXPOOL_OFF_ACTIVATIONS_MEM_SIZE
#define BUNDLE_MEM_ALIGN VGG_CIFAR_RELU_ON_MAXPOOL_OFF_MEM_ALIGN
#define BUNDLE_DATA_OFFSET VGG_CIFAR_RELU_ON_MAXPOOL_OFF_data
#define BUNDLE_OUTPUT_OFFSET VGG_CIFAR_RELU_ON_MAXPOOL_OFF_output
#define BUNDLE_INPUT_CHANNELS 3
#define BUNDLE_INPUT_HEIGHT 32
#define BUNDLE_INPUT_WIDTH 32
#define BUNDLE_NAME "relu_on_maxpool_off"
#elif defined(BUNDLE_CASE_RELU_ON_MAXPOOL_ON) && defined(BUNDLE_VARIANT_CIFAR)
#include "vgg_cifar_relu_on_maxpool_on.h"
#define BUNDLE_ENTRY vgg_cifar_relu_on_maxpool_on
#define BUNDLE_CONSTANT_MEM_SIZE VGG_CIFAR_RELU_ON_MAXPOOL_ON_CONSTANT_MEM_SIZE
#define BUNDLE_MUTABLE_MEM_SIZE VGG_CIFAR_RELU_ON_MAXPOOL_ON_MUTABLE_MEM_SIZE
#define BUNDLE_ACTIVATIONS_MEM_SIZE VGG_CIFAR_RELU_ON_MAXPOOL_ON_ACTIVATIONS_MEM_SIZE
#define BUNDLE_MEM_ALIGN VGG_CIFAR_RELU_ON_MAXPOOL_ON_MEM_ALIGN
#define BUNDLE_DATA_OFFSET VGG_CIFAR_RELU_ON_MAXPOOL_ON_data
#define BUNDLE_OUTPUT_OFFSET VGG_CIFAR_RELU_ON_MAXPOOL_ON_output
#define BUNDLE_INPUT_CHANNELS 3
#define BUNDLE_INPUT_HEIGHT 32
#define BUNDLE_INPUT_WIDTH 32
#define BUNDLE_NAME "relu_on_maxpool_on"
